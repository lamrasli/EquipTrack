...
import { PiDeskFill, PiClock, PiChartBar, PiCheckCircle } from "react-icons/pi";
    ...
    <div className="min-h-screen py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="absolute inset-0 z-0 opacity-15">
        <div 
          ...
          style={{
            backgroundImage: "url('https://previews.123rf.com/images/nete/nete1609/nete160900014/63560280-mosa%C3%AFque-blanche-et-noire-zellige-moroccan-transparente.jpg')",
      ...
      <div className="relative z-10">
        ...
        >
          ...
          >
            Système intégré de suivi du parc matériel du Ministère des Affaires Étrangères
          </motion.p>
          <motion.div
          ...
          {[
            {
              ...
              icon: <PiChartBar size={28} className="text-white" />,
              color: "bg-gradient-to-br from-red-700 to-red-600",
            },
            {
              value: `${counts.availability}%`,
              label: "Taux de disponibilité",
              icon: <PiCheckCircle size={28} className="text-white" />,
