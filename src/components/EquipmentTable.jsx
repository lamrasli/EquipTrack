...
const EquipmentTable = ({ equipmentList = [], onEdit, onDelete, user }) => {
  ...
  const exportToExcel = async () => {
    ...
    titleCell.value = "Ministère des Affaires Etrangères - Inventaire des Équipements";
    titleCell.font = {
      name: "Arial",
      size: 16,
      bold: true,
    ...
    equipmentList.forEach((equipment, index) => {
      ...
      switch (equipment.statut) {
        ...
        case "Réformé en stock":
          ...
          break;
        default:
          statusCell.font.color = { argb: "FF333333" };
          break;
      }
    });
    ...
    a.href = url;
    a.download = `MAE_Inventaire_Equipements_${new Date()
      .toISOString()
      .slice(0, 10)}.xlsx`;
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 p-6 border-b border-gray-200">
            ...
            <div className="bg-white p-5 rounded-xl shadow-sm border border-gray-200 flex items-center">
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-gray-800">
                  {filteredEquipmentList.filter(e => e.statut === "Fonctionnel").length}
                </p>
              </div>
            </div>
            ...
            <div className="bg-white p-5 rounded-xl shadow-sm border border-gray-200 flex items-center">
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-gray-800">
                  {filteredEquipmentList.filter(e => e.statut === "Réformé en stock").length}
                </p>
              </div>
            </div>
            ...
            <div className="bg-white p-5 rounded-xl shadow-sm border border-gray-200 flex items-center">
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-gray-800">
                  {filteredEquipmentList.filter(e => e.statut === "Réformé en bureau").length}
                </p>
              </div>
            </div>
          </div>
